...
<div class="container-fluid">
	<center><img src="<?= validate_image(isset($image_path) ? $image_path : "") ?>" alt="Product Image"
			class="img-thubmnail p-0 bg-gradient-gray" id="prod-img-view"></center>
	<dl>
		...
		<dd class="pl-3">
			...
			<?php else: ?>
			<span class="badge badge-danger bg-gradient-danger px-3 rounded-pill">Không hoạt dộng</span>
			<?php endif; ?>
		</dd>
	</dl>
