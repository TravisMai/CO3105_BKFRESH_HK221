<div class="content py-3">
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            <h5 class="card-title"><b>Danh sách đơn hàng</b></h5>
        </div>
        <div class="card-body">
            ...
            <table class="table table-bordered table-striped">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="p1 text-center">Ngày tạo</th>
                        <th class="p1 text-center">Mã đơn đặt</th>
                        <th class="p1 text-center">Tổng giá trị</th>
...
<script>
    $(function(){
        $('.view_data').click(function(){
            uni_modal("Chi tiết đơn hàng - <b>"+($(this).attr('data-code'))+"</b>","orders/view_order.php?id="+$(this).attr('data-id'),'mid-large')
        })
        $('table').dataTable();
    })
</script>