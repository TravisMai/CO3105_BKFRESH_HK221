                    ...
                    <div class="list-group">
                        ...
                        <div class="list-group-item list-group-item-action">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label for="cat_item<?= $row['id'] ?>" class="custom-control-label"> <?= $row['name'] ?>&nbsp;<span class="firstSpan"><i class="fa fa-info-circle"></i><span class="secondSpan"><?= $row['description'] ?></span></span></label>
                            </div>
                        </div>
                        <?php endwhile; ?>
                    </div>
