                ...
                <div class="row">
                    <div class="col-lg-4 col-md-5 col-sm-12 text-center">
                        <div class="position-relative overflow-hidden" id="prod-img-holder">
                            <img src="<?= validate_image(isset($avatar) ? $avatar : "") ?>" alt="<?= $row['avatar'] ?>"
                                id="prod-img" class="img-thumbnail" style="background-color:#f2faf4">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-7 col-sm-12">
                        ...
                        <a href="./?page=products/view_product&id=<?= $row['id'] ?>">
                            <h5 class="card-title text-truncate w-100 hah"><i class="fas fa-seedling fa-spin"
                                    style="color:#54c577"></i> &nbsp; <?= $row['name'] ?>
                            </h5>
                        </a>
                        <?php endwhile; ?>
                    </div>
